    ...
    internal static class Program
    {
        ...
        private sealed class TestSuite
        {
            ...
            public void PrintSummary()
            {
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Yellow;
                    Console.WriteLine("UNCERTAIN — partial legacy port support detected.");
                }
                else
                {
                ...
                Console.WriteLine("  • VMs and modern UEFI firmware may emulate port 0x61/0x42");
                Console.WriteLine("    without physical speaker hardware being present.");
                Console.WriteLine("  • A WARN on T07 (gate-off stability) is normal on emulators");
                Console.WriteLine("    that ignore the gate bit entirely.");
                Console.WriteLine("  • T08 enabled the speaker-data bit for 100 µs at 18 Hz —");
                Console.WriteLine("    0.18 % of one cycle, completely below auditory threshold.");
                Console.ResetColor();
            }
        }
