...
2. [Come posso contribuire?](#how-can-i-contribute)
- [Segnalazioni di bug](#bug-reports)
- [Richieste di funzionalità](#feature-requests)
- [Contributi al codice](#code-contributions)
- [Documentazione](#documentation)
- [Contributi ai file BMM e NBPML](#bmm-and-nbpml-file-contributions)
3. [Processo di pull request](#pull-request-process)
4. [Guide di stile](#style-guides)
- [Stile del codice](#code-style)
- [Note specifiche su C#](#c-sharp-specific-notes)
5. [Supporto della community](#community-support)

## 🌟 Codice Codice di Condotta
Partecipando a questo progetto, accetti di rispettare il Codice di Condotta. Si prega di essere rispettosi e premurosi nei confronti degli altri membri della community. Consulta il file `CODE_OF_CONDUCT.md` per i dettagli.
