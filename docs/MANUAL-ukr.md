...
- ## Відкриття та збереження файлу
  ...
  ![image](https://github.com/user-attachments/assets/b22df440-4c6f-4c98-be0f-b285b253737a)
...
- ## Налаштування
  ...
  - ### Загальні налаштування
    ...
    ![image](https://github.com/user-attachments/assets/e1498cd3-9ae7-4925-a6e1-8c7630f8260f)
    ...
    NeoBleeper надає надійні інструменти для перевірки виходу системного динаміка та діагностики проблем із підключенням або сумісністю. У розділі «Тестування системного динаміка» на вкладці «Загальні» в налаштуваннях ви знайдете дві окремі функції тестування:

    ![image](https://github.com/user-attachments/assets/15db1599-107d-4d02-b128-a4c0e46a18a7)
    
    **Тестування системного динаміка:**
    - Натисніть цю кнопку, щоб відобразити розкривний список із двома варіантами:
    - **Стандартний тест відтворення мелодії:** Відтворює просту мелодію, щоб перевірити, чи системний динамік відтворює звук належним чином.
    - **Розширений тест системного динаміка:** Виконує серію діагностичних перевірок для ретельної оцінки функціональності вашого динаміка та стабільності драйвера (див. деталі нижче).
    
    **Функції розширеного тестування системних динаміків**
    
    Коли ви обираєте «Розширений тест системних динаміків» зі спадного меню, NeoBleeper виконує кілька перевірок конфігурації вашого обладнання та програмного забезпечення, відображаючи результати у спливаючому вікні:

    ![image1](https://github.com/user-attachments/assets/c08ec6b0-a45d-4b0c-808a-6abe86a39c50)
    
    Виконуються такі тести:
    - **Тест електричного зворотного зв'язку:** Перевіряє очікувану електричну реакцію від обладнання системних динаміків.
    - **Тест стабільності стану порту:** Перевіряє стабільність стану порту та драйвера.
    - **Розширений тест частотної розгортки:** Виконує різні частоти, щоб забезпечити виведення широкого діапазону тонів.
    - **Загальний результат:** Підсумок, який вказує, чи всі тести пройдено, чи було виявлено певну проблему.
    
    Кожна перевірка відображається зі статусом (✔️ ПРОЙДЕНО або ❌ НЕ ПРОЙДЕНО).
    
    > Якщо ви не чуєте жодного звуку, можливо, вам доведеться скористатися функцією «Використовувати звуковий пристрій для створення звукового сигналу».
  ...
  - ### Налаштування створення звуків
    ...
    ![image](https://github.com/user-attachments/assets/21a95945-4624-4a3f-be04-c98224279561)
  ...
  - ### Налаштування пристроїв
    ...
    ![image](https://github.com/user-attachments/assets/ad420c38-938b-4001-bf2c-f84aebca2f91)
  ...
  - ### Налаштування зовнішнього вигляду
    ...
    ![image5](https://github.com/user-attachments/assets/b86c2b69-4282-4e1f-80ef-21f0f606a765)
  ...
  - ## Інструменти
    ...
    - ### Створюйте музику за допомогою ШІ - `Ctrl + Alt + A`
      ...
      ![зображення](https://github.com/user-attachments/assets/46a4ad81-a570-4e15-b722-f4bf5cd87b9c)
      ...
      **Вказівки щодо підказок та обмеження ШІ:**
      - Інструмент ШІ оброблятиме лише підказки, пов’язані з музичною композицією. Якщо ваша підказка не пов’язана з музикою (наприклад, «напишіть жарт»), ви отримаєте помилку:
         ...
         ![image](https://github.com/user-attachments/assets/98a9dc5d-cdc7-4f83-badd-2c5bc6847287)
        
        *"Виявлено немузичний запит. Ця система призначена для створення музики. Спробуйте запитати про створення пісні або музики, пов'язаної з виконавцем."*
      - Заборонено розміщувати підказки з образливим або неприйнятним контентом. У разі виявлення з’явиться повідомлення про помилку:
        ...
        ![image3](https://github.com/user-attachments/assets/741aaf68-b32a-4079-9fff-567e26e46da0) 

        *"Виявлено неприйнятний вміст. Будь ласка, спробуйте запит, що стосується музики, наприклад, назву пісні, ім'я виконавця або композитора."*
        - Спроба обійти протоколи безпеки, наприклад, наказати штучному інтелекту ігнорувати фільтри безпеки, призведе до помилки недійсного запиту:

        ![image3](https://github.com/user-attachments/assets/cd8b3532-c8f3-480b-ba14-76f3a8e62f4c)
        
        *"Виявлено спробу обходу інструкцій безпеки. Запити, що ігнорують або намагаються змінити попередні інструкції, заборонені. Будь ласка, спробуйте запитати про створення музичної композиції, музику за назвою пісні, виконавцем або композитором."*
    ...
    - ### Конвертувати в G-код - `Ctrl + Shift + G`
      ...
      Генеруйте G-код із музичних даних для використання на 3D-принтерах або ЧПУ-станках, щоб фізично відтворювати музичні послідовності за допомогою моторів чи інших компонентів. Оновлене вікно «Конвертувати файл у G-код» (див. нижче) спрощує вибір нот, прошивки та параметрів відтворення.

      ![image1](https://github.com/user-attachments/assets/f2c4c996-fea8-40fc-9988-722f48da80e2)
      
      **Основні функції та опції:**
      - **Вибір прошивки:**  
        Оберіть прошивку для вашого G-код-файлу, наприклад «Marlin», щоб забезпечити сумісність із вашим 3D-принтером або ЧПУ-станком.
      
      - **Ноти та типи компонентів:**  
        Для нот 1–4 оберіть тип G-код-команди (G0/G1 – мотор), призначте кожну ноту певній осі або компоненту.  
        Використовуйте прапорці біля кожної ноти, щоб зазначити, які саме ноти будуть включені у G-код («Відтворити ноту 1» тощо).
      
      - **Вибір осі:**  
        Вкажіть, яку вісь (X, Y або Z) мають контролювати команди G0/G1.  
        **Увага:** Команда G0/G1 переміщує вісь дуже швидко! Неправильне налаштування може призвести до механічних пошкоджень. Завжди ретельно перевіряйте конфігурацію.
      
      - **Опції послідовного та по-стовпчикового відтворення нот:**  
        * Відтворювати ноти послідовно по порядку  
        * Спершу відтворювати ноти у непарних стовпцях, потім у парних  
        Ці опції визначають, як кілька нот будуть послідовно включені до згенерованого файлу G-код.
      
      - **Експорт у G-код:**  
        Після налаштування параметрів натисніть «Експорт у G-код», щоб зберегти файл для вашого пристрою.
      
      Оновлений процес забезпечує точний контроль над тим, яка вісь чи компонент програє ноти, які саме ноти використовуються та як реалізується їхнє поєднання — ідеально для експериментальної інтеграції музики та руху.
