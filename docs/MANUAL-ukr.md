...
- ## Налаштування
  ...
  - ### Налаштування пристроїв
    ...
    Ця вкладка дозволяє налаштувати взаємодію NeoBleeper із зовнішнім MIDI-обладнанням та віртуальними інструментами. Незалежно від того, чи інтегруєте ви вхідний сигнал у реальному часі, чи маршрутизуєте вихідний сигнал на синтезатор, саме тут ви визначаєте потік сигналу.
  ...
  - ## Інструменти
    ...
    - ### Конвертувати в команду звукового сигналу для Linux - `Ctrl + Shift + B`
    
      Швидко конвертуйте свої музичні композиції в Linux-сумісний сценарій команди звукового сигналу для легкого відтворення на системах Linux.
      ...
      **Огляд функцій:**
        ...
        - Результатом є одна команда (або серія команд), яку можна виконати в терміналі Linux для відтворення музики за допомогою системного динаміка.
        
      **Як використовувати:**
        1. Створіть свою музику в NeoBleeper як завжди.
        2. Відкрийте інструмент «Конвертувати в команду звукового сигналу для Linux» у меню «Файл».
        3. Ваша музика буде миттєво конвертована в скрипт команди звукового сигналу та відображена в текстовому полі.
        4. Використовуйте кнопку «Копіювати команду звукового сигналу в буфер обміну», щоб скопіювати команду для використання в терміналі.
        5. Або ж збережіть команду як файл `.sh`, натиснувши «Зберегти як файл .sh» для подальшого виконання в будь-якій сумісній системі Linux.
