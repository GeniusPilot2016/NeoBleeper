...
- **Что вы можете заметить:**  
  ...
  ![image1](https://github.com/user-attachments/assets/a259e972-d01b-4926-a5d2-9993821ed079)
...
![image1](https://github.com/user-attachments/assets/24892fcc-fc83-4458-b03e-658a3470a9d9)
...
### 6.2 Устранение неполадок для очень новых или недокументированных моделей Gemini (например, Gemini 3 Pro Preview)

Некоторые модели Gemini, особенно совершенно новые версии, такие как **Gemini 3 Pro Preview**, могут не отображаться в официальной документации по ценам или квотам Gemini API при запуске. Вы можете столкнуться с ошибками квоты, доступа или «RESOURCE_EXHAUSTED», даже если общая квота вашей учётной записи неиспользована.

**Важные замечания для очень новых моделей:**
- Google часто ограничивает доступ к предварительным моделям (например, Gemini 3 Pro Preview) для отдельных учётных записей или определённых регионов и может устанавливать гораздо более строгие ограничения на запросы и использование.
- Учётные записи бесплатного уровня могут иметь нулевую квоту для этих моделей, или запросы могут быть полностью заблокированы.
- Модель может не отображаться на вкладках квот/цен или в документации Google в течение нескольких недель после выпуска.
- Цены, доступ и доступность новых моделей Gemini могут часто меняться.

**Что делать при возникновении ошибок:**
- Дважды проверьте [использование API и квоты](https://ai.dev/usage?tab=rate-limit) и наличие новой модели в консоли.
- Ознакомьтесь с [документацией по API Gemini](https://ai.google.dev/gemini-api/docs/rate-limits), но учтите, что документация может отставать от новых выпущенных моделей.
- Если вы видите ошибки типа «RESOURCE_EXHAUSTED» для модели, которая не задокументирована в официальных таблицах цен, это, вероятно, означает, что модель ещё не доступна для всех или имеет очень ограниченный доступ к предварительному просмотру.
- Дождитесь обновления документации Google и более широкого внедрения, если вам нужно использовать эти экспериментальные модели.

> **Примечание:**
> NeoBleeper и аналогичные приложения не могут обойти эти ограничения. Если ваша учётная запись или регион не подходят, вам следует дождаться официального разрешения доступа Google или увеличения квоты для выбранной вами модели Gemini.

---

### 6.3 Ограничения по региону или стране
...
### 6.4 Общие рекомендации по API ИИ
