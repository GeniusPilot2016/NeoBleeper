...
2. [Tôi có thể đóng góp bằng cách nào?](#how-can-i-contribute)
  - [Báo cáo lỗi](#bug-reports)
  - [Yêu cầu tính năng](#feature-requests)
  - [Đóng góp mã](#code-contributions)
  - [Tài liệu](#documentation)
  - [Đóng góp tệp BMM và NBPML](#bmm-and-nbpml-file-contributions)
3. [Quy trình yêu cầu kéo](#pull-request-process)
4. [Hướng dẫn kiểu](#style-guides)
  - [Kiểu mã](#code-style)
  - [Ghi chú cụ thể về C#](#c-sharp-specific-notes)
