![neobleeper_banner](https://github.com/user-attachments/assets/b2fb9e46-853c-4d77-9554-9c5abfaf39a6)

# 🖥️🎶🎹🤖 NeoBleeper: Майже забуте обладнання зустрічається з сучасними технологіями

**🎉 NeoBleeper — перший музичний плеєр, який може відтворювати музику через системні динаміки та має рідну українську мову**

NeoBleeper — це перше у світі програмне забезпечення для створення мелодій на основі штучного інтелекту, яке використовує системний динамік (він же PC Speaker) на материнській платі, натхненне програмним забезпеченням Bleeper Music Maker, яке [Robbi-985 (він же SomethingUnreal)](https://youtube.com/@SomethingUnreal) розроблялося приблизно наприкінці 2007 — початку 2008 років, але було закинуто у 2011 році через те, що в новіших версіях Windows звукові сигнали спрямовувалися на звуковий пристрій за замовчуванням, а не на системний динамік на материнській платі. NeoBleeper забезпечує стабільніший процес створення музики, вирішуючи проблему спрямування системних звукових сигналів на звуковий пристрій за замовчуванням, а не на системний динамік на материнській платі в новіших версіях Windows, шляхом доступу до фізичного порту системного динаміка 🖥️🎶*
...
Цей проєкт **все ще перебуває в розробці**, а ця версія є **бета-версією**. Будь ласка, використовуйте програму з урахуванням цього та надайте відгук, щоб допомогти покращити майбутні випуски.

## ✨ Функції

- ### 🖥️ Зручний, знайомий, більш ергономічний та більш природний інтерфейс
  ...
  ![image](https://github.com/user-attachments/assets/54440a2e-ac1b-4a79-acd1-e2bd8278cf80)
...
- ### ⏱️ Налаштування розміру музики та BPM
...
- ### 🚀 Більше, ніж просто ремейк
  ...
  - #### 🤖 Системний динамік зустрічає штучний інтелект
    ...
    ![image](https://github.com/user-attachments/assets/4cd64b85-9aab-49ac-9e04-0685fce05974)

    ![image](https://github.com/user-attachments/assets/8e79c79b-0f1a-424d-8461-b941540e924e)
  ...
  - #### ⌨️ Також ви можете використовувати свою звичайну клавіатуру як піаніно
...
*Ці функції доступні лише для версії з 64-бітною архітектурою, а версія з архітектурою ARM64 не має можливості генерувати звукові сигнали через системний динамік.

## 🖥️📃 Системні вимоги

**Версія Windows:** Windows 10 (1809 і вище) 64-розрядна/ARM64 (мінімум)/Windows 11 (рекомендовано)

**Процесор:** Intel® Core i3 або еквівалент (64-розрядний), або еквівалент ARM64 (наприклад, Qualcomm Snapdragon) (мінімум)
...
## ▶️ Запуск випущеного виконуваного файлу

Ви можете легко запустити NeoBleeper без компіляції, використовуючи попередньо зібраний виконуваний файл, доступний у розділі «Випуски».

### ⚙️ Інструкції з виконання

1. **Перейдіть на сторінку випусків**
- Відвідайте сторінку [Випуски](https://github.com/GeniusPilot2016/NeoBleeper/releases) на GitHub.

2. **Завантажте ZIP-файл**
- Знайдіть останній випуск, а потім завантажте ZIP-файл (наприклад: `neobleeper-1.0.0-beta-x64.zip` або подібний, залежно від вашої системи).

3. **Розпакуйте ZIP-файл**
- Клацніть правою кнопкою миші завантажений zip-файл і виберіть "Розпакувати все..." (у Windows) або скористайтеся бажаним розпакувальником zip-архівів.

4. **Запустіть виконуваний файл**
- Відкрийте розпаковану папку.
- Перейдіть до папки `NeoBleeper`
- Знайдіть і двічі клацніть `NeoBleeper.exe`, щоб запустити програму.

5. **(Необов’язково) Дозволити запити безпеки**
– Якщо Windows ідентифікує програму як таку, що надходить з Інтернету, вам може знадобитися прийняти запит безпеки або натиснути «Додаткова інформація», а потім «Запустити все одно».

**Встановлення не потрібне.**

Якщо у вас виникли проблеми із запуском NeoBleeper, переконайтеся, що ваша система відповідає вимогам, зазначеним вище.
...
## ⭐️ Підтримайте NeoBleeper!

Якщо вам подобається цей проект, будь ласка, подумайте про те, щоб [залишити зірочку ⭐️ на GitHub](https://github.com/GeniusPilot2016/NeoBleeper), щоб допомогти іншим знайти його!

## 🌟 Віха зі змішаними емоціями

П'яту зірку цьому проєкту було додано у дуже особистий та водночас гірко-солодкий момент: на світанку, після того, як я дізнався про смерть мого батька, поки він був за кордоном, зірку мені надала [Handsome Gato Inc.](https://github.com/handsomegato) (компанія з розробки WordPress та цифрового маркетингу), і невдовзі після цього було отримано близько 20 нових завантажень.

Це нагадування про те, що відкритий код — це не лише код та функції, а й особисті подорожі та історії, що стоять за кожним комітом і кожною зіркою. Дякуємо, що ви є частиною цієї подорожі.
