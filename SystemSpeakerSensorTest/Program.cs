...
namespace NeoBleeperSpeakerExistenceTest
{
    ...
    int frequencyHz,
    int durationUs, // artık mikro-saniye
    out string details)
        {
            byte original61 = 0;
        ...
        private static void PrintHeader()
        {
            ...
            Console.WriteLine($"Probe chirp: {ProbeFrequencyHz} Hz for {ProbeDurationMicroseconds} microseconds");
