...
## 📑 Índice
1. [Código de Conducta](#-c%C3%B3digo-de-conducta)
2. [¿Cómo puedo contribuir?](#%E2%80%8D%EF%B8%8F-c%C3%B3mo-puedo-contribuir)
    - [Informes de errores](#-informes-de-errores)
    - [Solicitudes de funciones](#-solicitudes-de-funciones)
    - [Contribuciones de código](#%E2%80%8D-contribuciones-de-c%C3%B3digo)
    - [Documentación](#-documentaci%C3%B3n)
    - [Contribuciones de archivos BMM y NBPML](#-contribuciones-de-archivos-bmm-y-nbpml)
3. [Proceso de solicitud de extracción](#%EF%B8%8F-proceso-de-solicitud-de-extracci%C3%B3n)
4. [Guías de estilo](#-gu%C3%ADas-de-estilo)
    - [Estilo de código](#-estilo-de-c%C3%B3digo)
    - [Notas específicas de C#](#-notas-espec%C3%ADficas-de-c)
5. [Soporte de la comunidad](#%E2%80%8D%E2%80%8D%E2%80%8D-soporte-de-la-comunidad)

## 🌟 Código de Conducta
Al participar en este proyecto, aceptas cumplir con el Código de Conducta. Sé respetuoso y considerado con los demás miembros de la comunidad. Consulta el archivo `CODE_OF_CONDUCT-es.md` para obtener más información.
