...
Этот проект **всё ещё находится в разработке**, некоторые функции и компоненты ещё не завершены, а некоторые части ещё не созданы. Предстоящая опубликованная версия станет **последним альфа-релизом**. Последующее обновление NeoBleeper перейдёт к **первой бета-версии**. Пожалуйста, используйте программу с учётом этого и оставляйте отзывы, которые помогут улучшить будущие версии.
