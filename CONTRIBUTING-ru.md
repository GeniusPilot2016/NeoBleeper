...
2. [Как я могу внести свой вклад?](#how-can-i-contribute)
  - [Отчёты об ошибках](#bug-reports)
  - [Запросы функций](#feature-requests)
  - [Внесение изменений в код](#code-contributions)
  - [Документация](#documentation)
  - [Внесение изменений в файлы BMM и NBPML](#bmm-and-nbpml-file-contributions)
3. [Процесс запроса на включение изменений](#pull-request-process)
4. [Руководства по стилю](#style-guides)
  - [Стиль кода](#code-style)
  - [Заметки, касающиеся C#](#c-sharp-specific-notes)
5. [Сообщество Поддержка](#community-support)
