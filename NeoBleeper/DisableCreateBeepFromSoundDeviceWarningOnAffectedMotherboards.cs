...
{
    public partial class DisableCreateBeepFromSoundDeviceWarningOnAffectedMotherboards : Form
    {
        bool darkTheme = false;
        public DisableCreateBeepFromSoundDeviceWarningOnAffectedMotherboards()
        {
            InitializeComponent();
        ...
        /// suspending and resuming layout and enabling double buffering to reduce flicker during theme
        /// changes.</remarks>
        ...
        private void disable_create_beep_from_sound_device_warning_on_certain_types_Shown(object sender, EventArgs e)
        {
