...
namespace NeoBleeper
{
    internal static class Program
    {
        ...
        {
            public static bool is_x64_based = System.Runtime.InteropServices.RuntimeInformation.ProcessArchitecture == Architecture.X64;
        ...
        static void Main()
        {
            ...
            neobleeper_init_architecture_warning architecture_warning = new neobleeper_init_architecture_warning();
                    ...
                    case true:
                        {
                            try
                            {
                                switch (eligability_of_create_beep_from_system_speaker.is_x64_based)
                                {
                                    case false:
                                        {
                                            creating_sounds.create_beep_with_soundcard = true;
                                            creating_sounds.permanently_enabled = true;
                                            throw new PlatformNotSupportedException("Operation is not supported on this platform: NeoBleeper has detected that your computer is not x64 based.");  
                                        }
                            ...
                            {
                                Debug.WriteLine(e.Message);
                                DialogResult result = architecture_warning.ShowDialog();
                                switch (result)
                                {
                                    case DialogResult.Yes:
                                        Application.Run(new main_window());
