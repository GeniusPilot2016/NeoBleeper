...
{
    public partial class DisableCreateBeepFromSoundDeviceWarningOnComputersWithoutSystemSpeakerOutput : Form
    {
        bool darkTheme = false;
        public DisableCreateBeepFromSoundDeviceWarningOnComputersWithoutSystemSpeakerOutput()
        {
            InitializeComponent();
