...
{
    public partial class PawnIOIsNotLoadedWarning : Form
    {
        bool darkTheme = false;
        public PawnIOIsNotLoadedWarning()
        {
            InitializeComponent();
        ...
        /// theme setting. If the theme is set to follow the system, the method detects the system's current theme and
        /// applies the corresponding style. The method also ensures that UI updates are performed efficiently and that
        /// changes are immediately reflected in the control's appearance.</remarks>
        ...
        private void linkLabelDownloadPawnIO_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            LinkHelper.OpenLink("https://pawnio.eu/"); // Open the namazso's PawnIO website in the default browser
        }
    }
}
