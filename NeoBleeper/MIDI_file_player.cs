...
namespace NeoBleeper
{
    public partial class MIDI_file_player : Form
    {
        ...
        private async void playbackTimer_Tick(object sender, EventArgs e)
        {
            ...
            // --- UI Güncelleme Bloğu ---
            // UI'ı periyodik olarak ve sadece gerektiğinde güncelle
            ...
            // --- Ses İşleme Bloğu ---
            // Bir önceki görev hala çalışıyorsa bu tiki atla
            ...
            // Ses işleme için yeni bir görev başlat
            _playbackTask = Task.Run(async () =>
            {
                try
                {
                    ...
                    while (_currentFrameIndex < _frames.Count)
                    {
                        ...
                        {
                            await ProcessCurrentFrame(); // Bu metot artık UI güncellemesi yapmayacak
                            _currentFrameIndex++;
                        }
                        else
                        {
                            break; // Gelecekteki çerçeve, döngüden çık
                        }
                    }
                }
