...
namespace NeoBleeper
{
    public static class SerialPortHelper
    {
        ...
        /// <summary>
        /// Retrieves the names of all serial ports available on the current computer.
        /// </summary>
        /// <remarks>Port names are platform-dependent and may vary between operating systems. The
        /// returned names can be used to open and communicate with serial ports using the SerialPort class.</remarks>
        /// <returns>An array of strings containing the names of the available serial ports. The array is empty if no serial
        /// ports are found.</returns>
        ...
        /// <summary>
        /// Retrieves an array of serial port names for the current computer.
        /// </summary>
        /// <remarks>Port names are platform-dependent and may vary between operating systems. The
        /// returned names can be used to open and communicate with serial ports using the SerialPort class.</remarks>
        /// <returns>An array of strings, each containing the name of a serial port available on the current computer. The array
        /// is empty if no serial ports are found.</returns>
        ...
        /// <summary>
        /// Determines whether any connected serial port is identified as a supported microcontroller device.
        /// </summary>
        /// <remarks>This method attempts to communicate with all available serial ports and checks for a
        /// response indicating a supported microcontroller. Ports that do not respond or cannot be opened are ignored.
        /// Use this method to quickly detect the presence of common microcontroller devices connected via serial
        /// ports.</remarks>
        /// <returns>true if at least one connected serial port responds as an Arduino, Raspberry Pi, or ESP32 microcontroller;
        ...
        /// <summary>
        /// Attempts to locate and open a serial connection to a supported microcontroller connected to the system.
        /// </summary>
        /// <remarks>This method searches all available serial ports and attempts to identify a connected
        /// microcontroller by sending an identification command. Supported microcontrollers include Arduino, Raspberry
        /// Pi, and ESP32 devices. If a connection is already established and open, it is reused. The returned
        /// SerialPort must not be disposed or closed by the caller, as it may be reused by subsequent calls.</remarks>
        /// <returns>A SerialPort instance representing an open connection to a compatible microcontroller. The port is
        /// configured and ready for communication.</returns>
        /// <exception cref="Exception">Thrown if no compatible microcontroller is found on any available serial port.</exception>
        ...
        /// <summary>
        /// Plays a sound by controlling the stepper motor at the specified frequency and duration.
        /// </summary>
        /// <remarks>If another sound is already playing, it will be stopped before starting the new one.
        /// This method requires a connected and available microcontroller. If no microcontroller is available, the
        /// operation will be aborted and microcontroller usage will be disabled.</remarks>
        /// <param name="frequency">The frequency of the sound to play, in hertz. Must be a positive integer.</param>
        /// <param name="duration">The duration, in milliseconds, for which the sound is played. Must be a non-negative integer.</param>
        /// <param name="nonStopping">If set to <see langword="true"/>, the motor continues running after the duration elapses; otherwise, the
        /// motor stops automatically.</param>
        ...
        /// <summary>
        /// Plays a sound using the microcontroller's buzzer at the specified frequency and duration.
        /// </summary>
        /// <remarks>If another buzzer sound is already playing, it will be stopped before the new sound
        /// begins. If no microcontroller is available, the operation will be aborted and microcontroller usage may be
        /// disabled. This method is thread-safe.</remarks>
        /// <param name="frequency">The frequency of the sound to play, in hertz. The actual frequency may be adjusted based on microcontroller
        /// settings.</param>
        /// <param name="duration">The duration of the sound, in milliseconds. Must be a positive value.</param>
        /// <param name="nonStopping">If set to <see langword="true"/>, the buzzer continues playing after the specified duration; otherwise, the
        /// buzzer stops automatically when the duration elapses.</param>
        ...
        /// <summary>
        /// Stops the motor sound playback on the connected microcontroller, if it is currently playing.
        /// </summary>
        /// <remarks>If no motor sound is currently playing, this method has no effect. If the
        /// microcontroller is unavailable or an error occurs during the stop operation, the method logs the error and
        /// may disable further microcontroller usage. This method is thread-safe.</remarks>
        ...
        /// <summary>
        /// Stops the buzzer sound on the connected microcontroller asynchronously.
        /// </summary>
        /// <remarks>If no microcontroller is available or an error occurs during the operation, the
        /// method logs the error and may disable further microcontroller usage. This method has no effect if the buzzer
        /// is not currently playing.</remarks>
        /// <returns>A task that represents the asynchronous operation of stopping the buzzer sound.</returns>
