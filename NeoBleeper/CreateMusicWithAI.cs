    ...
    public partial class CreateMusicWithAI : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Debug.WriteLine("API key is not set. Please set the API key in the environment variables.");
                    MessageBox.Show("API key is not set. Please set the API key in the environment variables.");
                    return;
                }
