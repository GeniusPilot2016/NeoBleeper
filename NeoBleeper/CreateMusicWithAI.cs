        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var googleResponse = await googleModel.GenerateContentAsync(
                    ...
                    $"- Treat as OFFENSIVE any prompt that uses local / phonetic word games, spoonerisms, spaced syllables, intentional misspellings, digit/asterisk substitutions (e.g. b*mb, b0mb) that conceal profanity, sexual, violent, extremist, or explosive terms.\r\n" +
