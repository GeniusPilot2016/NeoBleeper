...
namespace NeoBleeper
{
    public class SoundRenderingEngine
    {
        ...
        {
            // Robbi-985 (aka SomethingUnreal) Windows 7's beep.sys changes and lost in 2011.
            // We're fighting to bring it back to life in 2025... with direct hardware access. :D
        ...
        {
            // Rubbish system? No problem, we can synthesize voices directly to bypass sound device issues.
