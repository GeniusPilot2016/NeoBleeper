...
{
    public partial class disable_create_beep_from_sound_device_warning_on_affected_motherboards : Form
    {
        bool darkTheme = false;
        public disable_create_beep_from_sound_device_warning_on_affected_motherboards()
        {
            InitializeComponent();
